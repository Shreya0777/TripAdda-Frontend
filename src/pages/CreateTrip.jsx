    ...
    <div className="min-h-screen bg-sectionBg px-3 py-6 sm:px-4 sm:py-8 lg:px-6 lg:py-10">
      <div className="mx-auto max-w-6xl space-y-6 sm:space-y-8">
        ...
        <div className="rounded-2xl bg-cardBg p-4 shadow sm:p-6">
          <h2 className="mb-4 text-lg font-bold text-primary sm:mb-5 sm:text-xl">🧭 Basic Information</h2>
        ...
        {/* BUDGET */}
        <div className="rounded-2xl bg-cardBg p-4 shadow sm:p-6">
          <h2 className="mb-4 text-lg font-bold text-primary sm:mb-5 sm:text-xl">💰 Budget Details</h2>
        ...
        {/* STAY */}
        <div className="rounded-2xl bg-cardBg p-4 shadow sm:p-6">
          <h2 className="mb-4 text-lg font-bold text-primary sm:mb-5 sm:text-xl">🏨 Stay Details</h2>
        ...
        {/* ITINERARY */}
        <div className="rounded-2xl bg-cardBg p-4 shadow sm:p-6">
          <h2 className="mb-4 text-lg font-bold text-primary sm:mb-5 sm:text-xl">🗓 Itinerary</h2>
...
Day 3 - Cafe hopping`}
        ...
        {/* EXPERIENCE */}
        <div className="rounded-2xl bg-cardBg p-4 shadow sm:p-6">
          <h2 className="mb-4 text-lg font-bold text-primary sm:mb-5 sm:text-xl">✨ Travel Experience</h2>
        ...
        {/* RATINGS */}
        <div className="rounded-2xl bg-cardBg p-4 shadow sm:p-6">
          <h2 className="mb-4 text-lg font-bold text-primary sm:mb-5 sm:text-xl">⭐ Ratings</h2>
        ...
        {/* TAGS */}
        <div className="rounded-2xl bg-cardBg p-4 shadow sm:p-6">
          <h2 className="mb-4 text-lg font-bold text-primary sm:mb-5 sm:text-xl">🏷 Tags</h2>
